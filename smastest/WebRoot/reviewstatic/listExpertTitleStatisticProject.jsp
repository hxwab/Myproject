		...
		<body>
			<div id="top">
				<s:if test="listType == 1">
					统计分析&nbsp;&gt;&gt;&nbsp;一般项目&nbsp;&gt;&gt;&nbsp;<span class="text_red">参评专家统计</span>
				</s:if>
				<s:else>
					统计分析&nbsp;&gt;&gt;&nbsp;基地项目&nbsp;&gt;&gt;&nbsp;<span class="text_red">参评专家统计</span>
				</s:else>
			</div>			
			<div class="main">
				<div class="main_content">
					<s:form id="search" theme="simple" action="list" namespace="/statistic/review/expertTitle/project">
						<table class="table_bar">
							<tr height="28px">
								<td width="50px"><input type="button" id="export" value="导出" class="btn"/></td>
								<td align="right" style="vertical-align:middle;">
									<s:select cssClass="select" name="searchType" headerKey="-1" headerValue="--%{'请选择'}--" list="#{'1':'项目名称','2':'专家个数'}" />
						...
						<table id="list_table" class="table_list" cellspacing="0" cellpadding="0">
							<thead id="list_head">
								<tr class="tr_list1">
									...
									<td class="border0"><a id="sortcolumn0" href="" class="{if sortColumn == 0}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按项目名称排序">项目名称</a></td>
			...
			<script type="text/javascript" src="javascript/statistic/listExpertTitleStatisticProject.js?ver=<%=application.getAttribute("systemVersion")%>"></script>
		</body>
</html>
					...
					<table class="table view-table">
						<tbody>
							<tr>
								...
								<td class="text-left" width = "300"><input type="text" name="reward" class="form-control input-sm datePicker validate[required]" placeholder="请输入年份"></td>
								<td></td>
							</tr>
						</tbody>
					</table>
							...
							<table class="table table-striped view-table">
								<tbody>
									<tr>
										...
										<td class = "text-left"><input type="text" name="reward" class="form-control input-sm validate[required, custom[number]]" placeholder="请输入"></td>
										<td width = "100"></td>
									</tr>
									<tr>
										<td width = "100" class = "text-right"><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span></td>

						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding form-inline">
			                <tr class="table_main_tr2">
			                	<td class = "btn-group">
			                    	...
			                    	<button id = "list_enable" class = "btn btn-default btn-sm">启用</button>
			                    	<button id = "list_disable" class = "btn btn-default btn-sm">停用</button>
			                    	<button id = "list_assign_role" class = "btn btn-default btn-sm">分配角色</button>

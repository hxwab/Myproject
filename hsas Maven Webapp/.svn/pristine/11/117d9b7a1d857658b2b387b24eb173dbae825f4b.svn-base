...
<html>
    ...
    <body>
				...
				<textarea id="list_template" style="display:none;">
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0"
			                ...
			                <tr class="table_title_tr">
			                    ...
			                    <td width="100" ><a id="sortcolumn1" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按创建时间排序">创建时间</a></td>
			                    <td width="100" ><a id="sortcolumn2" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按创建时间排序">创建时间</a></td>
			                    <td width="100" ><a id="sortcolumn3" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按有效时间排序">有效时间</a></td>
			                    <td width="100"><a id="sortcolumn4" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按账号状态排序">账号状态</a></td>
			                    <td width="100"><a id="sortcolumn5" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按角色分配排序">角色分配</a></td>
			                </tr>
			                </thead>
			                <tbody>
			                {for item in root}
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding form-inline">
			                <tr class="table_main_tr2">
			                	<td class = "btn-group">
			                    	...
			                    	<button id = "list_delete" class = "btn btn-default btn-sm">启用</button>
			                    	<button id = "list_delete" class = "btn btn-default btn-sm">停用</button>
			                    	<button id = "list_delete" class = "btn btn-default btn-sm">分配角色</button>
		...
		<script>
			seajs.use("js/system/account/department/list.js", function(list) {
		         list.init(); 
		    });
		</script>
	</body>

					...
					<table class="table table-striped view-table">
						<tbody>
							...
							<tr>
								...
								<td class = "text-left"><input class="form-control input-sm validate[required]" type="text" name="mail.subject"></td>
								<td width="50"></td>
							</tr>
							...
							<tr>
								...
								<td class = "text-left" >
		    						...
		    						<input type="text" class='pull-right validation-file-input' name="solicitPapers.fileName" value="">
								</td>
								<td width="50"></td>
							</tr>
							<tr>
								...
								<td class = "text-left">
									<textarea class="form-control" rows="10" name="mail.body"></textarea>
								</td>
								<td width="50"></td>
							</tr>
							<tr>
								<td colspan="3">
									<div id="optr" class="btn_bar1 form-group">
										<div class="btn-group">
											<input class="btn btn-default btn-sm" type="submit" value="确定">

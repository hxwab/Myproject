...
<html>
    ...
    <body>
			...
			<div class="row main-content">
			    ...
			    <div class="col-xs-10">
				   <div class="survey_add addTable">
				    	<form action="solicitpapers/add.action" method="post" id="forumContribute">
				    	<input type="hidden" name="solicitPapers.type" value="1">
				    		<table width="100%">
				    			...
				    			<tr>
				    				...
				    				<td><input type="text" name="solicitPapers.birthday" class="form-control input-sm datePicker validate[custom[date]]" placeholder="请输入出生年月" data-date-format="yyyy-mm-dd"></td>
				    			</tr>
				    			<tr>
		...
		<script>
		    seajs.use("js/solicitPapers/forum.js", function(contribute) {
		    });
		</script>
	</body>
</html>
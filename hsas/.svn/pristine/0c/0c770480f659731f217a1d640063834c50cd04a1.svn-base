...
//			out.putNextEntry(zipEntry);
	...
	public static void zip(String zipFileName, File []files) throws Exception {
	        ZipOutputStream out = new ZipOutputStream(new FileOutputStream(zipFileName));
	        zip(out, files, "");
	        out.setEncoding("UTF-8");// 解决linux乱码
	...
	public static void zip(ZipOutputStream out, File[] f, String base) throws Exception {
	           ...
	           zipFile(out, f[i], base + f[i].getName());
	         }
	        
	    }
	    
	public static void zipFile(ZipOutputStream out, File f, String base) throws Exception {

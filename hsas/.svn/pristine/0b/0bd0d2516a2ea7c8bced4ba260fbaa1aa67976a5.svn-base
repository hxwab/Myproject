...
<html>
	...
	<body>
		...
		<div class="row mySlide">
			...
			<div class="col-xs-12">
				<div class="addTable">
					<form id="form_add_expert" action="expert/add.action" method="post" >
							...
							<table width="100%">
								<tbody>
									...
									<tr>
										...
										<td><s:select cssClass="form-control input-sm" name="person.ethnic" headerKey="" headerValue="--请选择--" list="ethnics"  listKey="name" listValue="name"/></td>
										<td width="100"></td>
									</tr>
									<s:if test="%{accountType==3}">
									<tr>
										<td width="150" class="text-right">单位：</td>
										<td><input class="form-control input-sm" type="text" name="person.agencyName" disabled="true" value="<s:property value='agencyName'/>"></td>
										<td width="100"></td>
									</tr>
									</s:if>
									...
									<s:else>
									<tr>
										<td width="150" class="text-right required-label">单位：<s:hidden name="accountType" /></td>
										<td>
											<input class="btn btn-default  select-agency" type="button" value="选择单位" />
											<div class="selected"></div>
											<input type="hidden" name="person.agencyId" class="form-control input-sm " placeholder="">
											<input type="hidden" name="person.agencyName" class="form-control input-sm " placeholder="">
										</td>
										<td width="100"></td>
									</tr>
									</s:else>
						...
						<div id="expert_info" style="display:none">
							<table width="100%">
								<tbody>
									<tr>
										<td width="150" class="text-right required-label">学科分组：</td>
										<td><s:select cssClass="form-control input-sm" name="group.name" headerKey="" headerValue="--请选择--" list="groups" listKey="name" listValue="name" /></td>
										<td width="100"></td>
									</tr>
									<tr>
									...
									<tr>
										<td width="150" class="text-right">职务：</td>
										<td><s:textfield cssClass="form-control input-sm" name="person.position" placeholder="请输入"/></td>
										<td width="100"></td>
									</tr>
									<tr>
										<td width="150" class="text-right">是否推荐专家：</td>
										<td><s:select cssClass="form-control input-sm" name="expert.isRecommend" list="#{'0':'否', '1':'是'}" /></td>
										<td width="100"></td>
									</tr>
									<tr>
						...
						<div id="optr" class="text-center">
							<div class="btn-group">
								...
								<input id="finish" class="btn  btn-default" type="button" style="display: none" value="完成" />
								<input id="retry" class="btn  btn-default" type="button" style="display: none" value="重填" />
								<input id="confirm" class="btn  btn-default" type="button" style="display: none" value="确定" />

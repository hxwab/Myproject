...
<html>
    ...
    <body>
							      ...
							      <tbody>
									...
									<tr>
										...
										<td class = "text-left" >
											...
											<a href="${product.file|pdfFile}" target="_blank">预览</a>
											{else} 暂无附件
											{/if}
										</td>
										<td class = "text-right"><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span></td>
								...
								<div role="tabpanel" class="tab-pane fade in active" id="basic">
									<table class="table table-striped table-bordered">
										<tbody>
											...
											<tr>
												<td width="100" class = "text-right view-key">审核操作</td>
												<td width="520" class = "text-center" colspan="3">
													{if product.submitStatus == 2}
													<button class="btn  btn-primary btn-first-audit" type="button">&nbsp;&nbsp;审&nbsp;&nbsp;核&nbsp;</button>
													{else}
													<span style="color:#FD5B78;">成果未提交,暂时无法审核!</span>
													{/if}
												</td>
											</tr>
										</tbody>
										...
										<tbody>
											...
											<tr>
												...
												<td class = "text-center">
													...
													{elseif product.submitStatus == 3}修改中
		...
		<script>
		    seajs.use("js/product/firstAudit/view.js", function(view) {
		         view.init(); 
		    });
		</script>
	</body>

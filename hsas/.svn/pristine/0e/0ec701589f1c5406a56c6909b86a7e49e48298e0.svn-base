		...
		<div class="row mySlide">
			...
			<div class="col-xs-12">
				...
				<div id="simple_search" style="display: none !important;">
					<form id="search" name="search" action="system/mail/list.action" method="post"
						  class="form-inline">
						...
						<table border="0" cellspacing="0" cellpadding="0" class="table_td_padding form-group pull-right">
							...
							<tr>
								...
								<td class = "btn-group" style = "display:block">
									 ...
									 <input id="list_search_more" class="btn btn-default " type="button" value="更多条件">
								</td>
							</tr>
							</tbody>
						</table>
								...
								<tr class="adv_tr">
									...
									<td class="adv_td1">
										<div class="input-daterange">
											<input class="input-sm datePicker" name="createDate1" value="" />
											<span class="add-on">至</span>
											<input class="input-sm datePicker" name="createDate2" value="" />
										</div>
									</td>
									<td class="adv_td1" width="100"></td>

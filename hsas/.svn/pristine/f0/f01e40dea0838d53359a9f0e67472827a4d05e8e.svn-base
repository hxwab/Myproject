			   ...
			   <div class="addTable">
					<form id="form_right" name="form_right" action="right/modify.action" method="post">
						<table width="100%">
							...
							<tbody><tr>
								<td width="180" class="text-right required-label">权限名称：</td>
							...
							<tr>
								<td class="text-right required-label">权限节点：</td>
							...
							<tr>
								<td class="text-right required-label">权限代码：</td>
							...
							<tr>
								<td class="text-right required-label">权限描述：</td>

...
<html>
	...
	<body>
		...
		<div class="row mySlide">
			...
			<div class="col-xs-12">
				<div class="addTable">
					<form id="form_modify_expert" action="expert/modify.action">
							...
							<table width="100%">
								<tbody>
									...
									<tr>
										...
										<td>
											<input class="btn btn-default  select-agency" type="button" value="选择机构" />
											<div class="selected">
												<div class="selected-link">
													<span class="label label-primary" id=""><s:property value="person.agencyName" /></span>
													<div class="delete-link"><i class="fa fa-times"></i></div>
												</div>
											</div>
											<s:hidden cssClass="form-control input-sm validate[required]" name="person.agencyName" />
										</td>
										<td width="100"></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><s:textfield cssClass="form-control input-sm validate[required, custom[cellphone]]" name="person.mobilePhone" placeholder="请输入"/></td>
										<td width="100"></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><s:textfield cssClass="form-control input-sm  validate[custom[telephone]]" name="person.officePhone" placeholder="请输入"/></td>
										<td width="100"></td>
									</tr>
									<tr>
										<td width="150" class="text-right">家庭电话：</td>
										<td><s:textfield cssClass="form-control input-sm validate[custom[telephone]]" name="person.homePhone" placeholder="请输入"/></td>
										<td width="100"></td>
									</tr>
									<tr>
						...
						<div id="optr" class="text-center">
							<div class="btn-group">
								...
								<input id="finish" class="btn  btn-default" type="submit" style="display: none" value="完成" />

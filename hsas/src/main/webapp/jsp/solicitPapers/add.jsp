...
<html>
    ...
    <body>
			...
			<div class="row main-content">
			    ...
			    <div class="col-xs-10 col-xs-offset-1">
				   <div class="survey_add addTable">
				    	<form id="form_solicitPapers" action="solicitPapers/add.action" method="post">
				    		<s:hidden name="type"></s:hidden>
				    		<table width="100%">
				    			<!-- 从前台向后台传数据两种方法1：直接写入name=对象名.属性值；2：加上required，在后台逐个访问标签 -->
				    			<tbody><tr>
				    				<td width="80" class="text-right required-label">名称：</td>
				    				<td><input type="text" name="solicitPapers.name" class="form-control input-sm validate[required]" placeholder="请输入投稿名称"></td>
				    			</tr>
				    			<tr>
				    				<td width="80" class="text-right required-label">申请人：</td>
				    				<td><input type="text" name="solicitPapers.author" class="form-control input-sm validate[required]" placeholder="请输入申请人姓名"></td>
				    			</tr>
				    			<tr>
				    			...
				    			<tr>
				    				<td width="80" class="text-right required-label">出生年月：</td>
				    				<td><input type="text" name="solicitPapers.birthday" class="form-control input-sm datePicker validate[custom[date]]" placeholder="请选择出生年月" data-date-format="yyyy-mm-dd"></td>
				    			</tr>
				    			<tr>
				    				<td width="80" class="text-right required-label">所在单位：</td>
				    				<td><input type="text" name="solicitPapers.unit" class="form-control input-sm validate[required]" placeholder="请输入您所在单位全称"></td>
				    			</tr>
				    			<tr>
				    				<td width="80" class="text-right required-label">联系电话：</td>
				    				<td><input type="text" name="solicitPapers.phone" class="form-control input-sm validate[required, custom[phone]]" placeholder="请输入手机号或固定电话"></td>
				    			</tr>
				    			<tr>
				    			...
				    			<tr>
				    				...
				    				<td><textarea class="form-control input-sm " name="solicitPapers.note" rows="8" placeholder="请简要描述内容"></textarea></td>
				    			</tr>
				    		</tbody>
				    	</table>
				    	<div class="text-center">
				            <div class="btn-group">
				            	...
				            	<input type="button" value="取消" class="btn btn-default " id="cancel" onclick="history.back();">
				            </div>
				        </div>
				   		</form>
				    </div>
		...
		<script>
		    seajs.use("js/solicitPapers/add.js", function() {
		    });
		</script>
	</body>
</html>
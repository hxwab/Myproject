					...
					<table class="table table-striped view-table">
						<tbody>
							<tr>
								...
								<td width = "100" class = "text-right view-key">权限名称：</td>
							...
							<tr>
								...
								<td class = "text-right view-key">权限节点：</td>
								<td width ='' class = "text-left" >${nodeValue }</td>
							</tr>
							<tr>
								<td class = "text-right"><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span></td>
								<td class = "text-right view-key">权限代码：</td>
								<td class = "text-left" colspan = "4">${code }</td>
							</tr>
							<tr>
								<td class = "text-right"><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span></td>
								<td class = "text-right view-key">权限描述：</td>

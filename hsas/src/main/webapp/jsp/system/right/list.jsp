	...
	<body>
		...
		<div class="row mySlide">
			<ol class="breadcrumb mybreadcrumb">当前位置：
				...
				<li><a href="right/toList.action?update=1">系统权限 </a></li>
			...
			<div class="col-xs-12 main-content">
				...
				<div id="simple_search" style="display: none !important;">
					<form id="search" name="search" action="right/list.action" method="post"
						  class="form-inline">
					...
					<form id="advSearch" action="advSearch" theme="simple" namespace="" method="post">
						...
						<div class="adv_content">
							<table class="adv_table" width="100%" border="0" cellspacing="2" cellpadding="0">
								<tr class="adv_tr">
									<td class="adv_td1" width="100" align="right">权限名称：</td>
					...
					<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-striped table-bordered dataTable no-footer">
						<thead id="list_head">
							<tr class="table_title_tr">
								...
								<td width="200"><a id="sortcolumn0" href="" class="{if sortColumn == 0}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按权限名称排序">权限名称</a></td>
								<td width="200"><a id="sortcolumn1" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按权限代码排序">权限代码</a></td>
								<td width="120" ><a id="sortcolumn2" href="" class="{if sortColumn == 2}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按权限节点值排序">权限节点值</a></td>
								<td width="200" ><a id="sortcolumn3" href="" class="{if sortColumn == 3}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按描述排序">描述</a></td>
							</tr>
						</thead>
						<tbody>
							{for item in root}
		...
		<!-- end footer -->
		<script>
			seajs.use("js/system/right/list.js", function(list) {
				 list.init(); 
			});
		</script>
	</body>

...
<html>
    ...
    <body>
			  ...
			  <li class="active">修改</li>
			    ...
			    <div class="col-xs-10 main-content">
				   <div class="survey_add addTable">
				    	<form id="form_role" name="form_role" action="role/modify.action" method="post">
				    		...
				    		<table width="100%">
				    			...
				    			<tbody><tr>
				    				...
				    				<td><s:textfield type="text" name="role.name" class="form-control input-sm validate[required]" placeholder="" /></td>
				    			</tr>
				    			<tr>
				    				<td width="80" class="text-right required-label">角色描述：</td>
				    				<td><s:textarea type="text" name="role.description" class="form-control input-sm validate[required]" placeholder=""  /></textarea></td>
				    			</tr>
				    			...
				    			<tr>
				    				...
				    				<td class = "row">
						    			...
						    			<div class="col-xs-1 no-padding"><input id="button_query" type="button" value="检索" class="btn btn-default  pull-right" /></div>	
				    				</td>
				    			</tr>
				    			<tr>
				    		...
				    		<div id="optr" class="btn_bar1">
				            	<div class="btn-group">
				            		<input type="button" value="确定" class="btn btn-default " id="submit">
		...
		<script>
		    seajs.use("js/system/role/modify.js", function(modify) {
		         modify.init(); 
		    });
		</script>
	</body>

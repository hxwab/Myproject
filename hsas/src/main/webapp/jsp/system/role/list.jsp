    ...
    <body>
   		...
   		<a name="top" id="top"></a>
			...
			<ol class="breadcrumb mybreadcrumb">当前位置：
			  <li><a href="#">系统管理</a></li>
			  <li><a href="role/toList.action?update=1">系统角色</a></li>
						...
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0"
			               ...
			               <thead id="list_head">
			                	<tr class="table_title_tr">
				                	<td width="10" class="text-center"><input id="check" name="check" type="checkbox" title="点击全选/不选本页所有项目"/></td>
				                    <td width="20" class="text-center">序号</td>
				                    <td width="50"><a id="sortcolumn0" href="" class="{if sortColumn == 0}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按角色名称排序">角色名称</a></td>
				                    <td width="300"><a id="sortcolumn1" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按角色描述排序">角色描述</a></td>
				                </tr>
			                </thead>
			                <tbody>
			                {for item in root}
			                <tr>
			                	<td width="10" class="text-center"><input type="checkbox" name="entityIds" value="${item.laData[0]}"/></td>
			                    <td width="20" class="text-center">${item.num}</td>
			                    <td width="50"><a id="${item.laData[0]}" class="link1" title="点击查看详细信息" type="1">${item.laData[1]}</a></td>
			                    <td width="300">${item.laData[2]}</td>
			                </tr>
			                {forelse}
			                <tr>

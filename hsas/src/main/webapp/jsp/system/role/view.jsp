...
<html>
    ...
    <body>
					    ...
					    <table class="table table-striped view-table">
					      <tbody>
							<tr>
								...
								<td width = "100" class = "text-right view-key">角色名称：</td>
								<td width ='300' class = "text-left">${name }</td>
								<td width = "50" class = "text-right"><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span></td>
								<td width = "100" class = "text-right view-key">创建者：</td>
								<td width ='' class = "text-left" ></td>
							</tr>
							<tr>
								
								<td width = "50" class = "text-right"><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span></td>
								<td width ='100' class = "text-right view-key">角色类型：</td>
								<td class = "text-left" colspan = "4"> </td>
							</tr>
							<tr>
								<td width = "50" class = "text-right"><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span></td>
								<td width = "100" class = "text-right view-key">角色描述：</td>
								<td class = "text-left" colspan = "4">${description }</td>
							</tr>
							<tr>
								<td width = "50" class = "text-right td-tree"><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span></td>
								<td width ='100' class = "text-right td-tree view-key">角色权限：</td>
								<td class = "text-left td-tree" colspan = "4" ><div id="treeparent" class="tree well"></div></td>
							</tr>
						  </tbody>
			    		</table>
			    	</textarea>
		...
		<script>
		    seajs.use("js/system/role/view.js", function(view) {
		         view.init(); 
		    });
		</script>
	</body>

...
<html>
		...
		<div class="row mySlide">
			...
			<div class="col-xs-12">
				...
				<div id="simple_search" style="display: none !important;">
					<form id="search" class="form-inline" name="search" action="reviewGroup/list.action?reviewType=1" method="post">
	...
	<script>
		seajs.use("js/assignExpert/secondReview/list.js", function(list) {
			list.init();
		});
	</script>
</html>
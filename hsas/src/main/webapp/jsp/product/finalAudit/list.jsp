    ...
    <body>
   		...
   		<a name="top" id="top"></a>
			...
			<ol class="breadcrumb mybreadcrumb">当前位置：
			  <li><a href="#">评审管理</a></li>
			  <li><a href="right/toList.action?update=1">终审</a></li>
			  <li class="active">列表</li>
			</ol>
			    <div class="col-xs-12 main-content">
				   
					<div id="simple_search" style="display: none !important;">
		                <form id="search" name="search" action="product/finalAudit/list.action" method="post"
		                      class="form-inline">
				...
				<textarea id="list_template" style="display:none;">
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0"
			                ...
			                <tr class="table_title_tr">
			                    ...
			                    <td width=80"><a id="sortcolumn0" href="" class="{if sortColumn == 0}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按成果编号排序">成果编号</a></td>
			                    <td width=300"><a id="sortcolumn0" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按角色名称排序">成果名称</a></td>
		...
		<script>
		    seajs.use("js/product/finalAudit/list.js", function(list) {
		         list.init(); 
		    });
		</script>
	</body>

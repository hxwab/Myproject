			    ...
			    <div class="col-xs-12 main-content">
			     <textarea id = "view_template" style = "display:none"><!-- 前台模版 -->
				    <div class="btn-group pull-right view-controler" role="group" aria-label="...">
				    	{if product.submitStatus == 2 || product.universityAuditResult==1 || product.hsasApplyAuditResult==1}
				    	<button type="button" class="btn  btn-default" id = "view_mod_unable">修改</button>
				    	{else}    
							...
							<div class="tab-content ">
								...
								<div role="tabpanel" class="tab-pane fade " id="firstReview">
									<table class="table table-striped table-bordered">
										<tbody>
											<tr>
												<td width = "100" class = "text-right">初评平均分</td>
												<td width = "500"class = "text-left" >${product.averageScore}</td>
											</tr>
											<tr>
												<td class = "text-right">初评意见</td>
												<td class = "text-left" ></td>
											</tr>
											<tr>
												<td class = "text-right">是否进入复评</td>
												<td class = "text-left" >
								...
								<div role="tabpanel" class="tab-pane fade " id="secondReview">
									<table class="table table-striped table-bordered">
										<tbody>
											<tr>
												<td width = "100" class = "text-right">推荐等级</td>
												<td width = "500"class = "text-left" >${product.rewardLevel}</td>
											</tr>
											<tr>
												<td class = "text-right">专家组意见</td>
												<td class = "text-left" >${product.rewardLevel}</td>
											</tr>
											<tr>
												<td class = "text-right">专家组审核结果</td>
												<td class = "text-left" >
								...
								<div role="tabpanel" class="tab-pane fade " id="finalAudit">
									<table class="table table-striped table-bordered">
										<tbody>
											<tr>
												<td width = "100" class = "text-right">终审审核结果</td>

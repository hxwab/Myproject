			  ...
			  <li class="active">列表</li>
			    ...
			    <div class="col-xs-12 main-content">
					...
					<div id="simple_search" style="display: none !important;">
		                <form id="search" name="search" action="product/firstReview/list.action" method="post"
		                      class="form-inline">
				...
				<textarea id="list_template" style="display:none;">
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0"
			               ...
			               <tr class="table_title_tr">
			                    ...
			                    <td width="70" class=""><a id="sortcolumn2" href="" class="{if sortColumn == 2}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按作者姓名排序">作者姓名</a></td>
			                	<td width="120" class=""><a id="sortcolumn3" href="" class="{if sortColumn == 3}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按机构名称排序">机构名称 </a></td>
			                  	...
			                  	<td width="70" class=""><a id="sortcolumn5" href="" class="{if sortColumn == 5}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按成果类型排序"> 成果类型</a></td>
			                  	...
			                  	<td width="70" class=""><a id="sortcolumn7" href="" class="{if sortColumn == 7}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按发表时间排序">发表时间</a></td>
			                  	<td width="100" class=""><a id="sortcolumn8" href="" class="{if sortColumn == 8}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按合作者排序">合作者</a></td>
			                  	<td width="70" class=""><a id="sortcolumn9" href="" class="{if sortColumn == 9}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按成果类型排序">成果类型</a></td>
			                  	<td width="70" class=""><a id="sortcolumn10" href="" class="{if sortColumn == 10}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按是否被所有专家评完排序">是否被所有专家评完</a></td>
			                  	<td width="90" class=""><a id="sortcolumn11" href="" class="{if sortColumn == 11}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按已评专家数排序">已评专家数</a></td>
			                </tr>
			                </thead>
			                <tbody>
			                {for item in root}
			                 <tr>
			                    ...
			                    <td class="">${item.laData[1]}</td>
		                      	<td class=""><a id="${item.laData[0]}" class="first-review" type="${ item.laData[10]}">${item.laData[2]}</a></td>
				...
				<textarea id="list_template" style="display:none;">
			                ...
			                <thead id="list_head">
			                 <tr class="table_title_tr">
			                	...
			                	<td width="120" class=""><a id="sortcolumn3" href="" class="{if sortColumn == 3}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按机构名称排序">机构名称 </a></td>
			                  	<td width="150" class=""><a id="sortcolumn4" href="" class="{if sortColumn == 4}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按所属分组排序">所属分组</a></td>
			                  	<td width="70" class=""><a id="sortcolumn5" href="" class="{if sortColumn == 5}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按成果类型排序"> 成果类型</a></td>
			                  	<td width="70" class=""><a id="sortcolumn6" href="" class="{if sortColumn == 6}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按发表刊物排序">发表刊物 </a></td>
			                  	<td width="70" class=""><a id="sortcolumn7" href="" class="{if sortColumn == 7}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按发表时间排序">发表时间</a></td>
			                  	<td width="100" class=""><a id="sortcolumn8" href="" class="{if sortColumn == 8}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按合作者排序">合作者</a></td>
			                  	<td width="70" class=""><a id="sortcolumn9" href="" class="{if sortColumn == 9}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按是否评完排序">是否评完</a></td>
			                </tr>
			                </thead>
			                <tbody>
			                {for item in root}
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding form-inline">
			                <tr class="table_main_tr2">
			                	<td class = "btn-group">
			                	<s:if test = 'hasSubmit == "0"'>
			                	<button class="submit-all btn btn-default ">所有已全部评完</button> 
			                	</s:if>
			                    </td>

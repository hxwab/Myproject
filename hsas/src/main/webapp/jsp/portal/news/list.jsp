			...
			<div class="row mySlide">
			    ...
			    <div class="col-xs-9 sidebar2 no-padding-left">
					<div id="simple_search" style="display: none !important;">
		                <form id="search" name="search" action="portal/news/list.action" method="post" class="form-inline">
				...
				<textarea id="list_template" style="display:none;">
					<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0"class="table table-striped table-bordered dataTable no-footer">
		                ...
		                <tr class="table_title_tr">
		                    ...
		                    <td width=""><a id="sortcolumn0" href="" class="{if sortColumn == 0}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按新闻标题排序">新闻标题</a></td>
		                    <td width="80"><a id="sortcolumn1" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按作者排序">作者</a></td>
		                	<td width="100"><a id="sortcolumn2" href="" class="{if sortColumn == 2}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按来源排序">来源</a></td>
		                	<td width="100"><a id="sortcolumn3" href="" class="{if sortColumn == 3}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}"  title="点击按发布时间排序">发布时间</a></td>
		                </tr>
		                </thead>
		                <tbody>
		                {for item in root}
		         ...
		         <s:form id="list" theme="simple" action="delete" namespace="/portal/news">

...
dhtmlXMenuObject.prototype._doOnContextBeforeCall = function(g, j) {
	...
	var c = (window.dhx4.isIE || window.dhx4.isOpera || window.dhx4.isKHTML || window.dhx4.isEdge ? g.offsetX : g.layerX);
	var a = (window.dhx4.isIE || window.dhx4.isOpera || window.dhx4.isKHTML || window.dhx4.isEdge ? g.offsetY : g.layerY);

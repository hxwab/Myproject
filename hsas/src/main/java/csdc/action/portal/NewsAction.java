...
public class NewsAction  extends BaseAction {
	...
	private static final String HQL = "select a.id, a.title, a.editor, a.source,a.createDate from Article a left join a.systemOption so where 1=1 ";
	...
	public Object[] simpleSearchCondition() {
		...
		if(type!=null){
			map.put("type", type);
			hql.append(" and so.name =:type order by a.createDate desc");
		}else {
